...
#----------------------------------------------------
#SBATCH -J dml_3       # Job name
#SBATCH -o dml_3.o%j    # Name of stdout output file
#SBATCH -e dml_3.o%j    # Name of stderr output file
...
cd .. /scratch/07199/scavic/dmlTACC/ConnectingRod/random/3
