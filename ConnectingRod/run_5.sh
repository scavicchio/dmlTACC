...
#----------------------------------------------------
#SBATCH -J dml_5       # Job name
#SBATCH -o dml_5.o%j    # Name of stdout output file
#SBATCH -e dml_5.o%j    # Name of stderr output file
...
cd .. /scratch/07199/scavic/dmlTACC/ConnectingRod/random/5
